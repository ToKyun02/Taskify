...
import { useInfiniteInvitations } from '@/hooks/useInfiniteInvitations';
...
export default function InvitedDashboardCard() {
  ...
  // 스크롤 컨테이너와 load more 요소의 ref 생성
  ...
  return (
    <div className='w-full rounded-lg bg-white py-6 md:py-4 lg:w-[1022px] lg:py-8'>
      {invitations.length === 0 ? (
        <div className='flex w-full flex-col gap-[105px] rounded-lg pb-20 pl-5 pr-5 pt-6 md:gap-16 md:rounded-2xl md:pb-[120px] md:pl-10 md:pr-10 lg:w-[960px]'>
        ...
        <div className='flex flex-col gap-6'>
          ...
          {/* 스크롤 컨테이너 */}
          <div ref={scrollContainerRef} className='scrollbar-hide h-[650px] overflow-y-auto px-8'>
            {/* 데스크탑 레이아웃 */}
